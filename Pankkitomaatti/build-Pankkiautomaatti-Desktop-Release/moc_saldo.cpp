...
#include "../Pankkiautomaatti/saldo.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Saldo_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 37, 0)
    ...
    "Saldo\0on_pushButton_Perruuta_clicked\0"
    ""
};
...
void Saldo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_pushButton_Perruuta_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Saldo::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Saldo.data,
      qt_meta_data_Saldo,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Saldo.stringdata))
