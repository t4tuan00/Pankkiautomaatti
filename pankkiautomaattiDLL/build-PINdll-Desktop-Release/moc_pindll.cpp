...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PINdll_t, stringdata) + ofs \
...
void PINdll::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PINdll *_t = static_cast<PINdll *>(_o);
        switch (_id) {
        case 0: _t->Pinruutu(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject PINdll::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PINdll.data,
      qt_meta_data_PINdll,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PINdll.stringdata))
        return static_cast<void*>(const_cast< PINdll*>(this));
