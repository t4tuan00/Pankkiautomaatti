...
public:
    ...
    void setupUi(QDialog *Pin)
    {
        ...
        layoutWidget = new QWidget(Pin);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(30, 130, 371, 181));
        ...
        pushButton_miinus = new QPushButton(layoutWidget);
        ...
        label->setGeometry(QRect(30, 30, 361, 71));
    ...
    void retranslateUi(QDialog *Pin)
    {
        ...
        pushButtonCancel->setText(QApplication::translate("Pin", "Peruuta", 0));
